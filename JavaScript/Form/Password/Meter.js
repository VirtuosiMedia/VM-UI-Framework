 ...
 * @license: MIT License
 * @description: Creates a password strength meter Requirements: MooTools 1.4
 *               Core - See http://mootools.net
 */
var PasswordMeter = new Class({
	...
	/**
	 * These top 1000 common passwords are from http://xato.net/passwords/more-top-worst-passwords/ and apparently they 
	 * cover approximately 91% of user passwords. O_o In other words, you shouldn't use or allow these on your sites.
	 */
	common: ['password', '123456', '12345678', '1234', 'qwerty', '12345', 'dragon', 'pussy', 'baseball', 'football', 
	         ...
	         'buddha', 'vanessa', 'sandman', 'naughty', 'douglas', 'honda', 'matt', 'azerty', '6666', 'shorty', 
	         'money1', 'beach', 'loveme', '4321', 'simple', 'poohbear', '444444', 'badass', 'destiny', 'sarah', 
	         'denise', 'vikings', 'lizard', 'melanie', 'assman', 'sabrina', 'nintendo', 'water', 'good', 'howard', 
	         'time', '123qwe', 'november', 'xxxxx', 'october', 'leather', 'bastard', 'young', '101010', 'extreme', 
	         'hard', 'password1', 'vincent', 'pussy1', 'lacrosse', 'hotmail', 'spooky', 'amateur', 'alaska', 'badger', 
	         'paradise', 'maryjane', 'poop', 'crazy', 'mozart', 'video', 'russell', 'vagina', 'spitfire', 'anderson', 
	         'norman', 'eric', 'cherokee', 'cougar', 'barbara', 'long', '420420', 'family', 'horse', 'enigma', 
	         'allison', 'raider', 'brazil', 'blonde', 'jones', '55555', 'dude', 'drowssap', 'jeff', 'school', 
	         'marshall', 'lovely', '1qaz2wsx', 'jeffrey', 'caroline', 'franklin', 'booty', 'molly', 'snickers', 
	         'leslie', 'nipples', 'courtney', 'diesel', 'rocks', 'eminem', 'westside', 'suzuki', 'daddy', 'passion', 
	         'hummer', 'ladies', 'zachary', 'frankie', 'elvis', 'reggie', 'alpha', 'suckme', 'simpson', 'patricia', 
	         '147147', 'pirate', 'tommy', 'semperfi', 'jupiter', 'redrum', 'freeuser', 'wanker', 'stinky', 'ducati', 
	         'paris', 'natalie', 'babygirl', 'bishop', 'windows', 'spirit', 'pantera', 'monday', 'patches', 'brutus', 
	         'houston', 'smooth', 'penguin', 'marley', 'forest', 'cream', '212121', 'flash', 'maximus', 'nipple', 
	         'bobby', 'bradley', 'vision', 'pokemon', 'champion', 'fireman', 'indian', 'softball', 'picard', 'system', 
	         'clinton', 'cobra', 'enjoy', 'lucky1', 'claire', 'claudia', 'boogie', 'timothy', 'marines', 'security', 
	         'dirty', 'admin', 'wildcats', 'pimp', 'dancer', 'hardon', 'veronica', 'fucked', 'abcd1234', 'abcdefg', 
	         'ironman', 'wolverin', 'remember', 'great', 'freepass', 'bigred', 'squirt', 'justice', 'francis', 
	         'hobbes', 'kermit', 'pearljam', 'mercury', 'domino', '9999', 'denver', 'brooke', 'rascal', 'hitman', 
	         'mistress', 'simon', 'tony', 'bbbbbb', 'friend', 'peekaboo', 'naked', 'budlight', 'electric', 'sluts', 
	         'stargate', 'saints', 'bondage', 'brittany', 'bigman', 'zombie', 'swimming', 'duke', 'qwerty1', 'babes', 
	         'scotland', 'disney', 'rooster', 'brenda', 'mookie', 'swordfis', 'candy', 'duncan', 'olivia', 'hunting', 
	         'blink182', 'alicia', '8888', 'samsung', 'bubba1', 'whore', 'virginia', 'general', 'passport', 'aaaaaaaa', 
	         'erotic', 'liberty', 'arizona', 'jesus', 'abcd', 'newport', 'skipper', 'rolltide', 'balls', 'happy1', 
	         'galore', 'christ', 'weasel', '242424', 'wombat', 'digger', 'classic', 'bulldogs', 'poopoo', 'accord', 
	         'popcorn', 'turkey', 'jenny', 'amber', 'bunny', 'mouse', '7007', 'titanic', 'liverpool', 'dreamer', 
	         'everton', 'friends', 'chevelle', 'carrie', 'gabriel', 'psycho', 'nemesis', 'burton', 'pontiac', 'connor', 
	         'eatme', 'lickme', 'roland', 'cumming', 'mitchell', 'ireland', 'lincoln', 'arnold', 'spiderma', 'patriots', 
	         'goblue', 'devils', 'eugene', 'empire', 'asdfg', 'cardinal', 'brown', 'shaggy', 'froggy', 'qwer', 
	         'kawasaki', 'kodiak', 'people', 'phpbb', 'light', '54321', 'kramer', 'chopper', 'hooker', 'honey', 
	         'whynot', 'lesbian', 'lisa', 'baxter', 'adam', 'snake', 'teen', 'ncc1701d', 'qqqqqq', 'airplane', 
	         'britney', 'avalon', 'sandy', 'sugar', 'sublime', 'stewart', 'wildcat', 'raven', 'scarface', 'elizabet', 
	         '123654', 'trucks', 'wolfpack', 'pervert', 'lawrence', 'raymond', 'redhead', 'american', 'alyssa', 
	         'bambam', 'movie', 'woody', 'shaved', 'snowman', 'tiger1', 'chicks', 'raptor', '1969', 'stingray', 
	         'shooter', 'france', 'stars', 'madmax', 'kristen', 'sports', 'jerry', '789456', 'garcia', 'simpsons', 
	         'lights', 'ryan', 'looking', 'chronic', 'alison', 'hahaha', 'packard', 'hendrix', 'perfect', 'service', 
	         'spring', 'srinivas', 'spike', 'katie', '252525', 'oscar', 'brother', 'bigmac', 'suck', 'single', 'cannon', 
	         'georgia', 'popeye', 'tattoo', 'texas', 'party', 'bullet', 'taurus', 'sailor', 'wolves', 'panthers', 
	         ...
	         'nigger', '159753', 'women', 'alpha1', 'trooper', 'hawkeye', 'head', 'freaky', 'dodgers', 'pakistan', 
	         'machine', 'pyramid', 'vegeta', 'katana', 'moose', 'tinker', 'coyote', 'infinity', 'inside', 'pepsi', 
	         'letmein1', 'bang', 'control'],

	/**
	 * @param string - selectors - The selectors for the password meters
	 */
	initialize: function(selectors){
		var meters = $$(selectors);
		var self = this;
		Array.each(meters, function(meter){
			meter.addEvents({
				'keyup': function(){self.getEntropy(meter, this.get('value'));},
				'blur': function(){self.getEntropy(meter, this.get('value'));}
			});
		});
	},
	
	getEntropy: function(meter, input){
		if (this.common.contains(input.toLowerCase())){
			this.getMeterValues(meter, -10);
		} else {
			var totalCharset = 0, charsets = [26, 26, 10, 1, 32];
			Array.each([/[a-z]/, /[A-Z]/, /[0-9]/, /[ ]/, /[^a-zA-Z\d\s:]/], function(pattern, index){
				totalCharset = (pattern.test(input)) ? totalCharset + charsets[index] : totalCharset;
			});
			var entropy = (input.length > 0) ? input.length * (Math.log(totalCharset) / Math.log(2)) : 0;
			this.getMeterValues(meter, entropy.toInt());
		}		
	},
	
	getMeterValues: function(meter, entropy){
		if (entropy < 0){
			var message = 'Common Insecure Password!', meterClass = 'insecure', entropy = 100;
		} else if (entropy == 0){
			var message = 'Please Enter A Password', meterClass = '';			
		} else if (entropy < 30){
			var message = 'Very Weak Password', meterClass = 'veryWeak';
		} else if (entropy < 50){
			var message = 'Weak Password', meterClass = 'weak';
		} else if (entropy < 75){
			var message = 'Medium Strength Password', meterClass = 'medium';
		} else if (entropy < 90){
			var message = 'Strong Password', meterClass = 'strong';
		} else if (entropy >= 90){
			var message = 'Very Strong Password', meterClass = 'veryStrong';
		}
		this.setMeter(meter, entropy, message, meterClass);
	},
	
	setMeter: function(meter, entropy, message, meterClass){
		var percent = (entropy <= 100) ? entropy : 100;
		...
		if (!$(containerId)){
			...
			var container = new Element('div', {
				id: containerId, 
				'class': 'passwordMeter'
			}).adopt(msg, progressContainer).inject(meter, 'after');
		} else {
